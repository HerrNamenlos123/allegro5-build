...
2>NUL del Release\allegro.lib
echo Done: REMOVE BINARIES NOW
...
echo [92mBuild the project [91mallegro [92min [91mRELEASE MODE [92mand close the window when you're done![0m
